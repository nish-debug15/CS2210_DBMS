...
-- 2. Employees hired after January 1, 1999
SELECT first_name, last_name, hire_date
FROM employees
WHERE hire_date > '1999-01-01';

-- 3. Employees whose first_name starts with 'J'
...
-- 5. Employees earning between $5,000 and $10,000
SELECT first_name, last_name, salary
FROM employees
...
-- 3. Retrieve from high_earners view
...
-- 2. Employees with job_id 'SA_REP' or 'IT_PROG'
...
-- LIKE OPERATOR
-- 1. Employees whose last_name contains 'll'
SELECT first_name, last_name
FROM employees
WHERE last_name LIKE '%ll%';

-- 2. Employees whose first_name has 'a' as second character
SELECT first_name, last_name FROM employees
WHERE first_name LIKE '_a%';

-- 3. Employees whose last_name starts with 'B' and ends with 'n'
SELECT first_name, last_name
FROM employees
...
-- 2. Employees who work in the same department as Steven King
